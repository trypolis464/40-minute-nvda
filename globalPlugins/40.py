...
class GlobalPlugin(globalPluginHandler.GlobalPlugin):
	...
	def check(self):
		if not self.first:
			self.first = True
			gui.messageBox("This product requires authorization and will continue to run in 40 minute mode until an authorization key has been purchased. The best way to update authorization for this product is to open your bank, and let the money pore out.", "activation", wx.ID_OK)
		while True:
			time.sleep(1)
